    ...
    public partial class InitialSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryPreference", x => x.ID);
                    table.ForeignKey(
                        name: "FK_CategoryPreference_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "9ae35cde-ce65-4bdd-9d05-689bac3ca7fc", "398d10fe-4b8d-4606-8e9c-bd2c78d4e001" },
                    { "780f92ba-bc4a-4603-ae82-a1371a238c11", "e310a6cb-6677-4aa6-93c7-2763956f7a97" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryPreference_UserId",
                table: "CategoryPreference",
                column: "UserId");
