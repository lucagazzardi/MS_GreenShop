...
var logger = new LoggerConfiguration()
  ...
  .WriteTo.File("logs/notification-.log", Serilog.Events.LogEventLevel.Verbose, builder.Configuration["SerilogOutputTemplate"], rollingInterval: RollingInterval.Day)
